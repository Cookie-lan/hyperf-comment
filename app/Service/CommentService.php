...
class CommentService
{
    ...
    public function create(array $data): bool
    {
        $insert = [
            ...
            'founder_id'          => Arr::get($data, 'founder_id'),
            'founder_type'        => Arr::get($data, 'founder_type'),
            'founder_name'        => Arr::get($data, 'founder_name'),
            'founder_avatar'      => Arr::get($data, 'founder_avatar'),
